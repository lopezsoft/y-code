...
<body>
    ...
    <p><strong><a href={{$msg['url']}} style="color: #070649; font-weight: bold">Confirmar cuenta</a><strong>
    <br>
    <br>
    <br>
            ...
            <tr>
                ...
                <td style="vertical-align:top; padding:7px 14px 7px 3px">
                    ...
                    <p style='font-size:12px; margin: 0px 0 6px; height: 30px'>
                        ...
                        <br>
                        <a href='https://ycodeaccounting.com/' style="color: #070649; font-weight: bold">Sitio web</a>
                    </p>
                </td>
            </tr>
        </table>
