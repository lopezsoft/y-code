...
import { TaxRatesService, TaxesService,
         TaxAccountingAccountService,
         ShippingFrequencyService
        } from 'src/app/services/general/index';

import { ShippingFrequency, TaxAccountingAccount, Taxes } from 'src/app/models/general-model';
import { Accounts } from 'src/app/models/accounting-model';
