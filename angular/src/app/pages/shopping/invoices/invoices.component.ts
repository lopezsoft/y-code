...
import { ShoppingService } from 'src/app/services/global';
...
export class InvoicesComponent extends JqxCustomGridComponent implements OnInit, AfterViewInit{
  ...
  ngAfterViewInit(): void {
    ...
    [
      ...
      { text: 'Punto de venta', datafield: 'branch_name', align: 'center', minwidth: 100},
      { text: 'Bodega', datafield: 'winery_name', align: 'center', minwidth: 100},
