...
export class PointsOfSaleComponent  extends JqxCustomGridComponent implements OnInit, AfterViewInit {
  ...
  ngAfterViewInit(): void {
    ...
    const lang= ts.translate;
		// ts.title = 'Puntos de venta';
    ts.crudApi = {
      create: '/companies/branchoffice/pointofsale/create',
      read: '/companies/branchoffice/pointofsale/read',
      update: '/companies/branchoffice/pointofsale/update',
  ...
  createData(): void {
    const ts = this;
    super.createData();
    ts.goRoute('companies/pointofsale/create');
  }

  editData(data: any): void {
    super.editData(data);
    this.goRoute(`companies/pointofsale/edit/${data.id}`);
  }
